...
const features = [
  {
    label: "Featured Menu",
    description: "Explore our most loved drinks and food.",
    href: "/menu",
    icon: (
  ...
  },
  {
    ...
    description: "Browse our growing library collection.",
    href: "/books",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Join workshops, clubs and social gatherings.",
    href: "/events",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
