...
const initialItems: MenuItem[] = [
  { id: 1, name: "Latte", category: "Coffee", price: "85", description: "Smooth espresso with steamed milk", available: true, image: "" },
  { id: 2, name: "Cappuccino", category: "Coffee", price: "90", description: "Rich espresso with foamed milk", available: true, image: "" },
  { id: 3, name: "Mocha", category: "Coffee", price: "95", description: "Chocolate and espresso topped with cream", available: true, image: "" },
  { id: 4, name: "Earl Grey Tea", category: "Tea", price: "65", description: "Classic bergamot-infused black tea", available: true, image: "" },
  { id: 5, name: "Green Tea", category: "Tea", price: "60", description: "Light and refreshing Japanese sencha", available: false, image: "" },
  { id: 6, name: "Mango Juice", category: "Juices", price: "70", description: "Freshly squeezed mango delight", available: true, image: "" },
  { id: 7, name: "Orange Juice", category: "Juices", price: "60", description: "100% fresh oranges", available: true, image: "" },
  { id: 8, name: "Scrambled Eggs", category: "Breakfast", price: "120", description: "Fluffy eggs with toast", available: true, image: "" },
  { id: 9, name: "Pancakes", category: "Breakfast", price: "135", description: "Stack of buttermilk pancakes with syrup", available: true, image: "" },
  { id: 10, name: "Club Sandwich", category: "Lunch", price: "150", description: "Triple-decker with chicken and bacon", available: true, image: "" },
  { id: 11, name: "Pasta Alfredo", category: "Lunch", price: "160", description: "Creamy fettuccine with parmesan", available: false, image: "" },
  { id: 12, name: "Croissant", category: "Bakery", price: "80", description: "Buttery, flaky French pastry", available: true, image: "" },
  { id: 13, name: "Blueberry Muffin", category: "Bakery", price: "85", description: "Freshly baked with juicy blueberries", available: true, image: "" },
  { id: 14, name: "Cheesecake", category: "Desserts", price: "120", description: "New York style with berry topping", available: true, image: "" },
  { id: 15, name: "Chocolate Cake", category: "Desserts", price: "130", description: "Rich layered fudge cake", available: true, image: "" },
];
...
export default function AdminMenuPage() {
  ...
  const [form, setForm] = useState({ name: "", category: "Coffee", price: "", description: "", available: true });
  ...
  const openAddModal = () => {
    setEditingItem(null);
    setForm({ name: "", category: "Coffee", price: "", description: "", available: true });
    setShowModal(true);
  };
